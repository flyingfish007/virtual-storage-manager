...
################################<ly
    ...
    def get_latency(self, context, search_opts):
        return self.conductor_rpcapi.get_latency(context, search_opts)
    ...
    def hs_rbd_cache_config_create(self, context, hs_rbd_cache_config):
        return self.conductor_rpcapi.hs_rbd_cache_config_create(context,
                                                                hs_rbd_cache_config)

    def hs_rbd_cache_config_get(self, context, id):
        return self.conductor_rpcapi.hs_rbd_cache_config_get(context, id)

    def hs_rbd_cache_config_get_by_rbd_id(self, context, rbd_id):
        return self.conductor_rpcapi.hs_rbd_cache_config_get_by_rbd_id(context, rbd_id)

    def hs_rbd_cache_config_get_all(self, context):
        return self.conductor_rpcapi.hs_rbd_cache_config_get_all(context)
